...
namespace WinFormUI
{
    public partial class Dashboard : Form
    {
        ...
        {
            customer.CustomerName = "Stas Berezin";
            customer.CheckingAccount = new Account();
            customer.SavingsAccount = new Account();

            customer.CheckingAccount.AccountName = "Stas is Checking Account";
            customer.SavingsAccount.AccountName = "Stas Savings Account";
