...
namespace ConsoleUI
{
    //delegate is when you pass a method rather than a prop
    //More information in ShooppingCardModel
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //we dont pass the parameteres here in GenerateTotal, because this function is simply sent to ShoppingCartModel class delegate
            //and in there it will execute the function with required params.
        ...
        //action similar to delegate but without implicit declaration
